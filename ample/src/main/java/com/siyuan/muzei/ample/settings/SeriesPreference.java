...
public class SeriesPreference extends DialogPreference {
	...
	public void setData(ArrayList<Category> data) {
		mCatData = new SeriesAdapter( data, new Item( getContext().getString( R.string.settings_filter_none_use ) ) );
	}
	...
	class SeriesAdapter extends BaseExpandableListAdapter {
		...
		public SeriesAdapter( ArrayList< Category > data, Item noneItem ){
			super();
			mData = data;
			mNoneItem = noneItem;
		}
		...
		public Object getChild(int groupPosition, int childPosition) {
			Category cat = getCategory( groupPosition );
			if( cat != null )
